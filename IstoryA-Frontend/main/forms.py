...
class createStory(forms.Form):
    ...
    startStory = forms.CharField(max_length=100, label="", required=True, widget=forms.TextInput(attrs={'class' : 'form-control text-input-user', 'placeholder' : 'Enter the first sentence of your future storyboard'}))
...
class createStoryHome(forms.Form):
	...
	startStory = forms.CharField(max_length=100, label="", required=True, widget=forms.TextInput(attrs={'class': 'form-control'}))
...
class regenerateStoryHome(forms.Form):
	...
	regenerateStartStory = forms.CharField(max_length=100, label="", required=True, widget=forms.TextInput(attrs={'class': 'form-control'}))
...
class validationStoryHome(forms.Form):
		...
		startStoryValidation = forms.CharField(max_length=100, label="", required=True, widget=forms.TextInput(attrs={'class': 'form-control'}))
